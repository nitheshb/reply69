...
//           );
  ...
  Widget chatViewListRealtimeDb(context) {
    ...
    ListView.separated(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return InkWell(
            onTap: () async {
              var snap = await FirebaseController.instanace.getChatOwnerId(
            ...
            child: ChatMenuIcon(
              ...
              isOnline: true,
              counter: "${NotifyData[index]['c'] -
                  searchGroupForReadCount['readCount']}",
              // counter: 0,
              msg: "${approvedGroups.contains(NotifyData[index]['chatId'])
                  ? NotifyData[index]['pm']
                  : NotifyData[index]['m']}",
              time: "${""}",
              ownerOrPrime: approvedGroups.contains(
                  NotifyData[index]['chatId']),
            ),
          );
        }
            ...
            Column(
              children: <Widget>[
                ...
                InkWell(
                  ...
                  child: new Text(
                      "Subscribe to a group", style: GoogleFonts.poppins(
                    fontSize: 14,
                    color: Colors.blue,
                ...
                children: <Widget>[
                  ...
                  Align(
                    ...
                    child: new Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Text("Type to find a group...!", style: TextStyle(
                              color: Colors.grey,
                              fontSize: 16,
  ...
  Widget chatViewList(context, userId, email, followingGroupss, data,
      followGroupState) {
    ...
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: StreamBuilder(
          stream: FirebaseController.instanace.fetchChatGroupsList(
                  ...
                  return InkWell(
                    onTap: () async {
                      ...
                      if (ds.data['approvedGroupsJson'] != null) {
                        ...
                        await Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                Conversation(followingGroupsLocal: widget
                                    ...
                                    approvedGroupsJson: ds
                                        .data['approvedGroupsJson'],
                                    userId: userId,
                                    senderMailId: email,
                                    chatType: "",
                                    waitingGroups: waitingGroups,
                    ...
                    child: Padding(
                      ...
                      child: ChatMenuIcon(
                        ...
                        time: lastMessagesIs['lastMsgTime'] == "" ? "" : Jiffy(
                            lastMessagesIs['lastMsgTime'].toDate())
                            .fromNow()
                            .toString(),
                      ),
                    ),
              ...
              return Shimmer.fromColors(
                  child: ListView.builder(
                      ...
                      itemBuilder:(context, index ){
                        return ListTile(
                          leading: Icon(Icons.add_circle, size: 50.0,),
                          title: SizedBox(
                            child: Container(
                              color: Colors.green,
                            ),
              ...
              Align(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      new Text('Loading or No added Groups',
    ...
    return Padding(
      ...
      child: Container(
          ...
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text(
              searchText, style: TextStyle(color: Colors.white, fontSize: 12),),
          )
      ),
    );
  }
  ...
  searchGroupsQuery(query) {
    if (query != null && ((query.length == 1))) {
      var followGroupState = FirebaseController.instanace.searchResultsByName(
          query);
                              ...
                              slivers: <Widget>[
                                SliverList(
                                  delegate: SliverChildBuilderDelegate(
                                                    ...
                                                    builder: (context) =>
                                                        Profile3(
                                                            ...
                                                            feeDetails: ds['payload'][index]['FeeDetails'] ??
                                                                [],
                                                            seasonRating: ds['payload'][index]['seasonRating'] ??
                                                                'NA',
                                                            thisWeekRating: ds['payload'][index]['thisWeekRating'] ??
                                                                'NA',
                                                            lastWeekRating: ds['payload'][index]['lastWeekRating'] ??
                                                                'NA',
                                                            followingGroupsLocal: widget
                                                                .followingGroupsLocal
                                                        )),
                                              );
                                            },
                                    ...
                                    childCount: snapshot.data['payload']
                                        .length ?? 0,
                                  ),
                                ),
          ...
          FloatingActionButton(
            ...
            onPressed: () async {
              ...
              if (allowGroupCreation) {
                ...
                _showBasicsFlash(context: context,
...
// UnFollow Group Function
  ...
  unFollowFun(chatId, userId) async {
    ...
    await Navigator.of(context).pushAndRemoveUntil(new MaterialPageRoute(
      builder: (BuildContext context) => MainScreen(userId: userId,
          followingGroupsLocal: widget.followingGroupsLocal),
    ), (Route<dynamic> route) => false);
  }
...
// Follow Group Function
  followFun(chatId, userId) async {
    print("check for doc id of group ${chatId}  id is ${userId}");
    // make an entry in db as joinedGroups
    try {
      //  this is for token
      SharedPreferences prefs = await SharedPreferences.getInstance();
      ...
      if (widget.followingGroupsLocal.length < 9) {
        print('i was at following groups 0 with length  ${widget
            .followingGroupsLocal.length}, ${chatId}');
                        ...
                        Row(
                          children: <Widget>[
                            Wrap(
                              ...
                              runSpacing: 1.0, // gap between lines
                              children:
                              _buildSelectedOptions(categories),
                            ),
                          ],
                        ),
