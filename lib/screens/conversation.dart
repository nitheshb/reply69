...
class _ConversationState extends State<Conversation> {
  ...
  profileRoute(context, origin) {
    Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => JoinPremiumGroup(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) {return MyImageEditorPro(
...
// this creates feedback entry for newGroup or a group which does not have entry yet in DB
                ...
                await Navigator.push(
                  context, new MaterialPageRoute(builder: (BuildContext context) => PowerFeedbacker(
      ...
      child: Row(
        children: <Widget>[
          Padding(
            ...
            child: CircleAvatar(
              backgroundImage: NetworkImage("${widget.groupLogo}"),
            ),
          ),
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    Text("${widget.groupTitle.toString().toUpperCase()}",
                      style: GoogleFonts.poppins(
                        fontSize: 15,
                        color: Color(0xff3A4276),
                        fontWeight: FontWeight.w800,
                ...
                Row(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text("${NumberFormat.compact().format(widget.followersCount) ?? '0'} Followers ",
                        style: GoogleFonts.poppins(
                          fontSize: 11,
        ...
        child: new PopupMenuButton(
            onSelected: (value) {
              if (value == "Profile") {
                ...
                Navigator.push(
                  context, new MaterialPageRoute(builder: (BuildContext context) => ReportScreen(chatId: widget.chatId, uId: widget.userId)),
                );
              }
              },
              ...
              child: new PopupMenuButton(
                  onSelected: (value) {
                    if (value == "Approve Payments") {
                      Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => JoinRequestApproval(
                        chatId: widget.chatId,
                        groupName: widget.groupTitle)),
                      );
                    } else if (value == "Expired Memberships") {
                      Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => GroupMembersHome(
                      ...
                      Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => GroupEarnings(),));
  ...
  sendMessageFun(){
    try {
      ...
      if (messageCount > 120 &&
        ...
        FirebaseController.instanace.sendToClear121Message(
            widget.chatId,
