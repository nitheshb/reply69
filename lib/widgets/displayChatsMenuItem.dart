...
class _ChatMenuIconState extends State<ChatMenuIcon> {
  ...
  Widget build(BuildContext context) {
    print('status of amiprime :${widget.amiPrime}');
    print('status of amiowner ${widget.amiOwner}');
//    var doc = Firestore.instance.collection('groups').where('createdBy',isEqualTo: widget.user).snapshots();
//    print('docdatais:{$doc}');
    return Container(
      decoration: widget.amiPrime || widget.amiOwner ? new BoxDecoration (
          ...
          child: ListTile(
            ...
            title: Text(
              ...
              style: GoogleFonts.poppins(
                        fontSize: 15,
                        color: widget.amiPrime || widget.amiOwner ?  Colors.white :Color(0xff3A4276),
